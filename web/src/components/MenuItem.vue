  ...
  <div :class="[
    ...
    <div :class="compact ? '' : 'px-6 py-4 pb-6'">
      ...
      <div class="flex items-center gap-2">
        ...
        <span v-if="item.type === 'vegetarian'" class="text-green-600" role="img" aria-label="Vegetarisch">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" :class="compact ? 'size-3' : 'size-4'" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
      ...
      <div v-if="(item.restaurant && showRestaurant) || (item.foodtruck && !compact)" class="mt-3 flex gap-2">
        <div v-if="item.restaurant && showRestaurant" class="flex items-center px-3 py-1 bg-gray-200 rounded-full">
        ...
        <div v-if="item.foodtruck && !compact" class="flex items-center px-3 py-1 bg-amber-100 text-amber-800 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4" aria-hidden="true">
